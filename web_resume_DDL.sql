...
;
DROP TABLE IF EXISTS SERTIFICATION CASCADE
;
...
ALTER TABLE EDUCATION ADD CONSTRAINT FK_EDUCATION_GENERAL_DATA 
...
ALTER TABLE EXPERIENCE ADD CONSTRAINT FK_EXPERIENCE_GENERAL_DATA 
	FOREIGN KEY (GEN_DAT_ID) REFERENCES GENERAL_DATA (GEN_DAT_ID)
	ON DELETE CASCADE ON UPDATE CASCADE
;
...
ALTER TABLE SERTIFICATION ADD CONSTRAINT FK_SERTIFICATION_GENERAL_DATA 
	FOREIGN KEY (GEN_DAT_ID) REFERENCES GENERAL_DATA (GEN_DAT_ID)
	ON DELETE CASCADE ON UPDATE CASCADE
;
